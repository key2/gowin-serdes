...
//
// The vendor usb3_link.vg netlist (synthesized for the GW5AT-60, which has
// SSRAM/LUT-RAM) hard-instantiates RAM16SDP1/2/4 cells.  The GW5AST-138 die
// has no SSRAM resource, so the packaging step renames those instances to
// usb3_ram16sdp* and these register-based equivalents are synthesized
// instead (16 deep -- a handful of FFs and LUT muxes each).
//
